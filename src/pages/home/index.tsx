        ...
        <Layout active='Home'>
            <div className='overflow-y-scroll w-full h-[90vh]'>
                ...
                <div className='w-full p-4'>
                    <h1 className='w-full text-left text-xl text-black'>| Home</h1>
                </div>
                ...
                {/* recent */}
                <div className='w=full p-4'>
                    <h2 className='text-base w-full text-left'>Recent</h2> <hr />
                ...
                {/* shared */}
                <div className='w=full p-4'>
                    <h2 className='text-base w-full text-left'>Shared</h2> <hr />
